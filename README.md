...
```
git clone https://github.com/sup3rgiu/GassistPi-IT   
```
...
AIY-HAT and CUSTOM-HAT users, please reboot the Pi at places mentioned, else it will lead to audio and taskbar issues.**  
  ...
  ```
  sudo chmod +x /home/pi/GassistPi-IT/audio-drivers/USB-DAC/scripts/install-usb-dac.sh  
  sudo /home/pi/GassistPi-IT/audio-drivers/USB-DAC/scripts/install-usb-dac.sh
  speaker-test  
  ```

  3.2. AIY-HAT users,  
  ```
  sudo chmod +x /home/pi/GassistPi-IT/audio-drivers/AIY-HAT/scripts/configure-driver.sh  
  sudo /home/pi/GassistPi-IT/audio-drivers/AIY-HAT/scripts/configure-driver.sh  
  sudo reboot  
  sudo chmod +x /home/pi/GassistPi-IT/audio-drivers/AIY-HAT/scripts/install-alsa-config.sh  
  sudo /home/pi/GassistPi-IT/audio-drivers/AIY-HAT/scripts/install-alsa-config.sh  
  speaker-test  
  ```

  3.3. USB MIC AND HDMI users,  
  ```
  sudo chmod +x /home/pi/GassistPi-IT/audio-drivers/USB-MIC-HDMI/scripts/install-usb-mic-hdmi.sh  
  sudo /home/pi/GassistPi-IT/audio-drivers/USB-MIC-HDMI/scripts/install-usb-mic-hdmi.sh  
  speaker-test  
  ```

  3.4. USB MIC AND AUDIO JACK users,  
  ```
  sudo chmod +x /home/pi/GassistPi-IT/audio-drivers/USB-MIC-JACK/scripts/usb-mic-onboard-jack.sh  
  sudo /home/pi/GassistPi-IT/audio-drivers/USB-MIC-JACK/scripts/usb-mic-onboard-jack.sh  
  speaker-test  
  ```

  3.5. CUSTOM VOICE HAT users,  
  ```
  sudo chmod +x /home/pi/GassistPi-IT/audio-drivers/CUSTOM-VOICE-HAT/scripts/install-i2s.sh  
  sudo /home/pi/GassistPi-IT/audio-drivers/CUSTOM-VOICE-HAT/scripts/install-i2s.sh
  sudo reboot
  sudo chmod +x /home/pi/GassistPi-IT/audio-drivers/CUSTOM-VOICE-HAT/scripts/custom-voice-hat.sh  
  sudo /home/pi/GassistPi-IT/audio-drivers/CUSTOM-VOICE-HAT/scripts/custom-voice-hat.sh  
  speaker-test   
  ```
...
**Pi3 and Armv7 users use the "gassist-installer-pi3.sh" installer and Pi Zero, Pi A and Pi 1 B+ users use the "gassist-installer-pi-zero.sh" installer.**  
	...
	```
	sudo chmod +x /home/pi/GassistPi-IT/scripts/gassist-installer-pi3.sh
	sudo chmod +x /home/pi/GassistPi-IT/scripts/gassist-installer-pi-zero.sh
	...
	```
	sudo  /home/pi/GassistPi-IT/scripts/gassist-installer-pi3.sh  
	sudo  /home/pi/GassistPi-IT/scripts/gassist-installer-pi-zero.sh
...
```
sudo chmod +x /home/pi/GassistPi-IT/scripts/service-installer.sh
```  

3. Run the service installer  

```
sudo /home/pi/GassistPi-IT/scripts/service-installer.sh    
```  
...
```
/home/pi/env/bin/python -u /home/pi/GassistPi-IT/src/main.py --device_model_id 'replace this with the model id'

```
**Pushbutton/Pi Zero/Pi B+ and other users**   
Open a terminal and execute the following:
```
/home/pi/env/bin/python -u /home/pi/GassistPi-IT/src/pushbutton.py --project-id 'replace this with your project id'  --device-model-id 'replace this with the model id'
