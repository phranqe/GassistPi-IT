...
sed 's/#.*//' /home/pi/GassistPi-IT/Requirements/GassistPi-system-requirements.txt | xargs sudo apt-get install -y
if [ ! -d /home/pi/.config/mpv/scripts/ ]; then
  mkdir -p /home/pi/.config/mpv/scripts/
fi
if [ -f /home/pi/GassistPi-IT/src/end.lua ]; then
  mv /home/pi/GassistPi-IT/src/end.lua /home/pi/.config/mpv/scripts/end.lua
fi
if [ -f /home/pi/GassistPi-IT/src/mpv.conf ]; then
  mv /home/pi/GassistPi-IT/src/mpv.conf /home/pi/.config/mpv/mpv.conf
fi
...
pip install -r /home/pi/GassistPi-IT/Requirements/GassistPi-pip-requirements.txt
